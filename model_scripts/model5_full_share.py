...
for i,filter_size in enumerate(filter_sizes):
    ...
    with tf.name_scope("convolution-pooling-%s" %filter_size):
        ...
        pooled2=tf.nn.max_pool(h2, ksize=[1,sequence_length2-filter_size+1,1,1], strides=[1,1,1,1], padding='VALID',name="pool2")
...
saver.save(sess, "model_share_full/model.ckpt")
