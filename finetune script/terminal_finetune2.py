...
with tf.variable_scope('optimizers_loss'):
    ...
    losses = tf.nn.l2_loss(output_z - D_real)
    ...
    TOPIC = tf.group(train_op8 , train_op7 , train_op6 , train_op5, train_op4)
...
for epoch in range(0,num_epochs):
        ...
        for start, end in zip(range(0, number_of_training_data, batch_size),range(batch_size, number_of_training_data, batch_size)):
            ...
            # "======="
            if model_select == 1 or model_select == 2 or model_select == 4 or model_select == 5:  
                ...
                feed_dict1 = {input_x2: trainX[start:end],dropout_keep_prob: 0.5 , input_x1: trainY[start:end] , input_x3: dummy_input1 ,\
                    prediction_label1: Tens , output_z: Z[start:end] } 
                ...
                feed_dict3 = {input_x2: trainX[start:end],dropout_keep_prob: 0.5 , input_x1: dummy_input1 , input_x3: dummy_input2 ,\
                    prediction_label1: Tens  }    
                feed_dict1 = {input_x2: trainX[start:end],dropout_keep_prob: 0.5 , input_x1: trainY[start:end] , input_x3: dummy_input1 ,\
                    prediction_label1: sevens , prediction_label2: nines  , output_z:  Z[start:end] } 
                feed_dict4 = {input_x2: trainX[start:end],dropout_keep_prob: 0.5 , input_x1: dummy_input2 , input_x3: dummy_input1 ,\
                    prediction_label1: fives , prediction_label2: nines , output_z:  Z[start:end]  }            
            # "======="
            # sess.run([epoch_step ])
...
import os    
folder_name  = "fine_tuned_12%d" %(model_select)
